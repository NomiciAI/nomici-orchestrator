...
See [Quickstart](docs/quickstart.md) for the guided setup path, scriptable setup flags, and the optional no-API-key smoke test. See [Local Workspace Demo Script](docs/local-workspace-demo.md) and [Troubleshooting](docs/troubleshooting.md) when validating a fresh machine.
...
- Use the built-in default team or customize it in Console.
...
- Built-in default team templates
